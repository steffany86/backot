...
- `vite.config.ts` debe tener:
  ...
  - `server.allowedHosts` incluyendo `.ngrok-free.app` y `.ngrok-free.dev`
...
```properties
app.cors.allowed-origins=http://localhost:5173,http://127.0.0.1:5173,https://front-prueba-def.vercel.app,https://*.ngrok-free.app,https://*.ngrok-free.dev
```
