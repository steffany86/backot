...
public class SupervisionRepository {
    ...
    /**
     * Fallback para instalaciones donde los SP de aprobacion quedaron
     * desactualizados o devuelven cero aunque el inicio siga pendiente.
     */
    public int aprobarInicioJornadaDirecto(Integer idInicio, Integer idSupervisor, String nombreSupervisor) {
    ...
    public int rechazarInicioJornadaDirecto(Integer idInicio) {
        return tigohogarJdbcTemplate.update(
                "UPDATE dbo.tbl_InicioJornadaAlturas " +
                        "SET e_eliminado = 1 " +
                        "WHERE id_inicio = ? " +
