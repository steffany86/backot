...
final class OtDbSupport {
    ...
    private final Integer defaultSucursalId;
    ...
    OtDbSupport(
            ...
            String dbParams,
            Integer defaultSucursalId
    ) {
        this.sucursalRepository = sucursalRepository;
        this.dbDriver = dbDriver;
        this.dbParams = dbParams;
        this.dbUsername = firstNonBlank(sucreUsername, "CHANGE_ME");
        this.dbPassword = firstNonBlank(sucrePassword, "CHANGE_ME");
    ...
    JdbcTemplate resolveTemplate(Integer idSucursal, JdbcTemplate defaultJdbcTemplate) {
        ...
        // Santa Cruz trabaja con la base indicada en spring.datasource.url
        // (BDPruebas2); no debe ser reemplazada por la base histórica del SP.
        if (defaultSucursalId != null && defaultSucursalId.equals(idSucursal)) {
