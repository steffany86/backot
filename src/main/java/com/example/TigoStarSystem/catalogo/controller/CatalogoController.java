...
public class CatalogoController {
    ...
    public ResponseEntity<ApiResponse<List<Map<String, Object>>>> listarReglasAutoMaterial(
            @RequestHeader(value = "X-Session-Token", required = false) String token,
            @RequestParam(value = "idSucursal", required = false) Integer idSucursal) {
        Integer idSucursalResolved = resolveOptionalIdSucursal(token, idSucursal);
        return ResponseEntity.ok(ApiResponse.of(
                catalogoService.listarReglasAutoMaterial(idSucursalResolved),
                "Listado de reglas de autocarga de materiales."));
    }
    ...
    public ResponseEntity<ApiResponse<List<Map<String, Object>>>> sugerirSeries(
            ...
            @RequestParam(value = "tipoMaterialNombre", required = false) String tipoMaterialNombre,
            @RequestParam(value = "idSucursal", required = false) Integer idSucursal) {
        Integer idSucursalResolved = resolveOptionalIdSucursal(token, idSucursal);
        return ResponseEntity.ok(ApiResponse.of(
                catalogoService.sugerirSeriesPorPrefijo(q, limite, idProducto, idRuta, tipoMaterial, tipoMaterialNombre, idSucursalResolved),
